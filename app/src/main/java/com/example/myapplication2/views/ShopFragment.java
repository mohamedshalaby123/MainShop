...
import com.example.myapplication2.adapters.ShopListAdapter;
import com.example.myapplication2.databinding.FragmentShopBinding;
...
public class ShopFragment extends Fragment implements ShopListAdapter.ShopInterface {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // HINT : shopRecyclerView is the id used in xml file
    ...
    // when clicked -> add product to cart
    @Override
    public void addItem(Product product) {
        ...
        if (isAdded){
            ...
            Snackbar.make(requireView(),product.getName() + "Already have the max quanity in cart",Snackbar.LENGTH_LONG).show();

        }

    }

    // when item clicked -> go to product detail fragment
    @Override
