...
public class CartRepo {
    ...
    private MutableLiveData<List<CartItem>> mutableCart = new MutableLiveData<>(); // will be observed
    private MutableLiveData<Double> mutableTotalPrice = new MutableLiveData<>();

    public LiveData<List<CartItem>> getCart(){ // will be observed in shop view model
    ...
    public boolean addItemToCart(Product product){
        ...
        // merge product if it is already exist
